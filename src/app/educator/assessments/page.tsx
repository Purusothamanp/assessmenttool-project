...
export default function ManageAssessments() {
  ...
  const stats = [
    { label: 'Active Studio', value: totalAssessments, icon: BookOpen, color: '#059669', filterKey: 'all' },
      ...
      <div className="premium-card" style={{ padding: '0', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
        <div style={{ padding: '1rem 1.25rem', borderBottom: '1px solid var(--card-border)', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ minWidth: 0 }}>
            <h3 style={{ fontSize: '1.1rem', fontWeight: 700, marginBottom: '0.15rem' }}>Active Assessments</h3>
                  ...
                  >
                    <td style={{ padding: '1rem 0.75rem', borderRadius: '0.75rem 0 0 0.75rem' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                        <div style={{ width: '36px', height: '36px', flexShrink: 0, background: 'white', border: '1px solid #e2e8f0', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--educator-primary)' }}>
                          <FileText size={18} />
                        </div>
                        <div style={{ minWidth: 0 }}>
        ...
        {showModal && (
          <div style={{
            ...
            >
              ...
              <div style={{ marginBottom: '3rem' }}>
                <label style={{ display: 'block', fontSize: '0.8rem', marginBottom: '1.25rem', fontWeight: 700, color: 'var(--secondary)', textTransform: 'uppercase' }}>Supported Question Types</label>
              ...
              <div style={{ marginBottom: '3rem', borderTop: '1px solid #f1f5f9', paddingTop: '3rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2.5rem' }}>
                  <div>
                    <h3 style={{ fontSize: '1.5rem', fontWeight: 800 }}>Questions</h3>
